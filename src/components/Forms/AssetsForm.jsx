...
const AssetsForm = () => {
  ...
  const onFinish = async (values) => {
    values.Serial = values.Serial.replace(/[\t\n\s]+/g, '')
      ...
      <Space direction="vertical" size="middle" style={{ display: 'flex' }}>
        <Row gutter={16}>
          <Col className="gutter-row" span={24} md={{ span: 12 }}>
            <Form.Item label="SERIAL NUMBER" name="Serial" rules={[{ required: true, message: 'Serial is Required!' }]}>
              <Input style={{ marginBottom: '10px' }} placeholder="Basic usage" />
            </Form.Item>
          </Col>
          <Col className="gutter-row" span={24} md={{ span: 12 }}>
            <Form.Item label="ITEM" name="ItemName" rules={[{ required: true, message: 'Item is Required!' }]}>
              <Input style={{ marginBottom: '10px' }} placeholder="Basic usage" />
            </Form.Item>
          </Col>
          <Col className="gutter-row" span={24} md={{ span: 12 }}>
            <Form.Item
              label="SPECIFICATION"
              name="Specs"
              rules={[{ required: true, message: 'Specifications is Required!' }]}
            >
              <Input style={{ marginBottom: '10px' }} placeholder="Basic usage" />
            </Form.Item>
          </Col>
          <Col className="gutter-row" span={24} md={{ span: 12 }}>
            <Form.Item label="OS" name="os" rules={[{ required: true, message: 'OS is Required!' }]}>
              <Input style={{ marginBottom: '10px' }} placeholder="Basic usage" />
            </Form.Item>
          </Col>
          <Col className="gutter-row" span={24} md={{ span: 12 }}>
            <Form.Item label="Employee" name="employee" rules={[{ required: true, message: 'Employee is Required!' }]}>
              <Select
          ...
          <Col className="gutter-row" span={24} md={{ span: 12 }}>
            <Form.Item label="Building" name="Building" rules={[{ required: true, message: 'Building is Required!' }]}>
              <Select
                style={{ marginBottom: '10px', display: 'block' }}
                allowClear
                placeholder="Select a person"
          ...
          <Col className="gutter-row" span={24} md={{ span: 12 }}>
            <Form.Item label="Floor" name="Floor" rules={[{ required: true, message: 'Floor is Required!' }]}>
              <Input style={{ marginBottom: '10px' }} placeholder="Basic usage" />
            </Form.Item>
          </Col>
          <Col className="gutter-row" span={24} md={{ span: 12 }}>
            <Form.Item label="Office" name="Office" rules={[{ required: true, message: 'Office is Required!' }]}>
              <Input style={{ marginBottom: '10px' }} placeholder="Basic usage" />
            </Form.Item>
          </Col>
        </Row>
